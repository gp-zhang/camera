...
public class Camera {
    ...
    public void takePicture(String filePath, boolean forceOrientation, @NonNull final Result result) {
        ...
        pictureImageReader.setOnImageAvailableListener(
                reader -> {
                    try (Image image = reader.acquireLatestImage()) {
                        ...
                        if (forceOrientation) {
                          //get picture degree ,
                          //In some devices, the degree is always 0
                          float degree = readPictureDegree(file.getPath());
                          Bitmap bitmap = BitmapFactory.decodeFile(filePath);
                            Bitmap resizedBitmap = rotateBitmap(bitmap, -currentOrientation + degree);
