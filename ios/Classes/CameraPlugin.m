...
- (UIImageOrientation)getImageRotation {
    ...
    float yxAtan = (atan2(_motionManager.accelerometerData.acceleration.x,_motionManager.accelerometerData.acceleration.y
                          )) *
    180 / M_PI;
...
- (void)captureToFile:(NSString *)filename forceOrientation:(BOOL)forceOrientation result:(FlutterResult)result;
@end
...
- (void)captureToFile:(NSString *)path forceOrientation:(BOOL)forceOrientation result:(FlutterResult)result {
...
- (void)handleMethodCallAsync:(FlutterMethodCall *)call result:(FlutterResult)result {
    if ([@"availableCameras" isEqualToString:call.method]) {
        ...
        if ([@"takePicture" isEqualToString:call.method]) {
            [_camera captureToFile:call.arguments[@"path"] forceOrientation:[call.arguments[@"forceOrientation"] boolValue] result:result];
